	...
	return (
		<>
			<a
				...
				className="
					h-11 w-11
					bg-black-secondary mb-4 ml-auto
					border border-solid border-black-secondary rounded
					flex items-center justify-center
				">
				<svg version="1.1" viewBox="0 0 10 4" xmlns="http://www.w3.org/2000/svg" width="12px" height="7px" style={{ transform: 'rotate(90deg)' }}>
			...
			<p>
				...
				Política de Privacidade, não hesite em nos contatar em <a href="mailto:partnersturbo@gmail.com">partnersturbo@gmail.com</a>.
			</p>
